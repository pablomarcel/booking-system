...
def test_generate_booking_quote_1():
    ...
    objPac1 = booking_system.DataClasses.Package('dangerous', 5, 120, '07/01/21')
    book1 = booking_system.DataClasses.Booking(objP1, objPac1)
    assert booking_system.ProcessingClasses.FileProcessor.generate_booking_quote(book1) == (False, True, True)
    pass

def test_generate_booking_quote_2():
    objP1 = booking_system.DataClasses.Customer('Pablo', 'Marcel')
    objPac1 = booking_system.DataClasses.Package('Non-dangerous', 5, 120, '07/01/21')
    book1 = booking_system.DataClasses.Booking(objP1, objPac1)
    assert booking_system.ProcessingClasses.FileProcessor.generate_booking_quote(book1) == (False, True, True)
    pass
...
def test_generate_booking_quote_3():
    objP1 = booking_system.DataClasses.Customer('Pablo', 'Marcel')
    objPac1 = booking_system.DataClasses.Package('dangerous', 5, 120, '06/11/21')
    book1 = booking_system.DataClasses.Booking(objP1, objPac1)
    assert booking_system.ProcessingClasses.FileProcessor.generate_booking_quote(book1) == (False, True, False)
    pass

def test_generate_booking_quote_4():
    objP1 = booking_system.DataClasses.Customer('Pablo', 'Marcel')
    objPac1 = booking_system.DataClasses.Package('Non-dangerous', 5, 120, '06/11/21')
    book1 = booking_system.DataClasses.Booking(objP1, objPac1)
    assert booking_system.ProcessingClasses.FileProcessor.generate_booking_quote(book1) == (True, True, False)
    pass
